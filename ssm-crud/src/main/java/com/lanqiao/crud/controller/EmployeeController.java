package com.lanqiao.crud.controller;
...
import com.lanqiao.crud.bean.Msg;
import com.lanqiao.crud.service.EmployeeService;
...
public class EmployeeController {
	...
	public Msg checkuse(@RequestParam("empName") String empName) {
		...
		if (!empName.matches(regex)) {
			return Msg.fail().add("va_msg", "用户名必须是6-16数字和字母的组合或者2-5位中文");
		}
	...
	/**
	 * 员工保存 1、支持JSR303校验 2、导入Hibernate-Validator Valid 代表该对象需要被校验
	 * 
	 * @param employee
	 * @return
	 */
	...
	@ResponseBody
	// 因为表单中封装的name值，与形参中对象的属性对应，所以可以直接这样写，会被自动封装好。
