						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control"
									id="email_update_input" placeholder="email@lanqiao.com">
				...
				<div class="modal-body">
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control"
									id="email_add_input" placeholder="email@lanqiao.com"> <span
									class="help-block"></span>
							</div>
						</div>
						<div class="form-group">
									...
									.ajax({
										...
										success : function(result) {
											...
											if (result.code == 100) {
												...
												//2、来到最后一页,显示刚才保存的数据
												//发送ajax请求显示最后一页数据即可
												//总记录数为页码肯定没问题(因为添加一条数据，不好判断是在当前页还是另一页)
												to_page(totalRecord);
											} else {
												//显示失败信息
												//console.log(result);
												...
												if (undefined != result.extend.errorFileds.empName) {
													...
													show_validate_msg(
															"#empName_add_input",
															"error",
															result.extend.errorFileds.empName);
												}
											}
										}
									});
